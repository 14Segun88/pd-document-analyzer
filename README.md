...
🔥 **Live Demo:** Анализатор развернут онлайн и работает на базе NVIDIA API (модель Llama-3.1-70B). Попробуйте загрузить PDF по ссылке: [http://5.101.119.90:5006/](http://5.101.119.90:5006/)
